  ...
  send: function(cb) {
    ...
    */
    scheduleLambda: function (scheduleAttributes, swfAttributes) {
      ...
      ta.id = scheduleAttributes.name; // scheduleAttributes.name required

      // lambda function
      if(typeof scheduleAttributes.lambdaFunction === "string") {
         ta.name = scheduleAttributes.lambdaFunction;
      }
      ...
      this.addDecision({
         ...
         "scheduleLambdaFunctionDecisionAttributes": ta
      });
   },
